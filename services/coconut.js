 ...
 *   - 720p:  H.264 High, CRF quality=5, maxrate 4000k
 *   - 1080p: H.264 High, CRF quality=5, maxrate 14000k
 *   - 2160p: H.264 High, CRF quality=5, maxrate 24000k
 */
  ...
  const jobPayload = {
    ...
    outputs: {
      httpstream: {
        ...
        variants: [
          'mp4:x:64k',
          'mp4:720p::quality=5,maxrate=4000k,vprofile=high',
          'mp4:1080p::quality=5,maxrate=14000k,vprofile=high',
          'mp4:2160p::quality=5,maxrate=24000k,vprofile=high'
        ]
      }
    }
  };
